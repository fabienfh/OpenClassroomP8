...
Il n’est pas nécessaire d’entraîner un modèle pour le moment. L’important est de mettre en place les premières briques de traitement qui serviront lorsqu’il faudra passer à l’échelle en termes de volume de données !

Contraintes
Tenir compte dans nos développements du fait que le volume de données va augmenter très rapidement après la livraison de ce projet. Nous développerons donc des scripts en Pyspark et utiliserons par exemple le cloud AWS pour profiter d’une architecture Big Data (EC2, S3, IAM), basée sur un serveur EC2 Linux.

Données
Les données sont disponibles à l'adresse : https://www.kaggle.com/datasets/moltean/fruits
